    ...
    <div class="w-full max-w-6xl px-4 py-10 grid md:grid-cols-2 gap-10 items-center">
        <div class="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
            ...
            <div class="flex gap-8 justify-center md:justify-start">
                <div class="w-36 h-36 rounded-full border shadow flex items-center justify-center overflow-hidden">
                    <img src="{{ asset('image/brgylogo.jpg') }}" alt="Barangay Logo" class="w-full h-full object-cover">
                </div>
                <div class="w-36 h-36 rounded-full border shadow flex items-center justify-center overflow-hidden">
                    <img src="{{ asset('image/projnmax.jpg') }}" alt="SK Logo" class="w-full h-full object-cover">
                </div>
            </div>
            <p class="text-gray-700 text-lg italic">Manage Barangay Information with Ease</p>
        </div>

        <div class="bg-white border rounded-xl shadow-md p-8 w-full">
